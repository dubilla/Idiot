...
// angular_templates.markups: ["erb", "slim", "str"]
...
(function() {
  angular.module('degrees', ['infinite-scroll']).config(function($httpProvider) {
...
(function() {
  ...
  GameCtrl = (function() {
    function GameCtrl($http, GameService) {
      this.$http = $http;
      this.GameService = GameService;
      this.path = [];
      this.page = 1;
      this.completed = false;
      this.songs = this.getSongs(2);
    }

    GameCtrl.prototype.getSongs = function(artistID) {
      return this.GameService.findAll({
        artistID: artistID
      }).then((function(_this) {
        return function(response) {
          _this.artist = response.data.artist;
          return _this.songs = response.data.songs;
        };
      })(this));
    };

    GameCtrl.prototype.getSongsPage = function(artistID) {
      return this.gameService.findAll({
        artistID: this.artist.id,
        page: this.page
      }).then((function(_this) {
        return function(response) {
          return _this.songs.concat(response.data.songs);
        };
      })(this));
    };

    GameCtrl.prototype.chooseArtist = function(song) {
      this.path.push(song);
      if (song.artist.id === 1421) {
        return this.completed = true;
      } else {
        return this.getSongs(song.artist.id);
      }
    };
...
(function() {
  angular.module('degrees').factory('GameService', function($http) {
    var Property;
    return new (Property = (function() {
      function Property() {}

      Property.prototype.findAll = function(obj) {
        return $http.get("/songs.json?artist_id=" + obj.artistID + "&page=" + obj.page);
      };

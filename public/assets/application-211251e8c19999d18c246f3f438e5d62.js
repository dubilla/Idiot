...
(function() {
  angular.module('degrees', []).config(function($httpProvider) {
...
(function() {
  ...
  GameCtrl = (function() {
    function GameCtrl($http, GameService, $scope) {
      this.$http = $http;
      this.GameService = GameService;
      this.path = [];
      this.completed = false;
      this.songs = this.getSongs(parseInt($scope.artist, 10));
    }
...
(function() {
  angular.module('degrees').factory('GameService', function($http) {
    var GameService;
    return new (GameService = (function() {
      function GameService() {}

      GameService.prototype.findAll = function(obj) {
        return $http.get("/songs.json?artist_id=" + obj.artistID + "&page=1");
      };
